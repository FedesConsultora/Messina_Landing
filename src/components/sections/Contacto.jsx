...
const Footer = () => (
    <footer id="contacto" className="footer">
        <div className="footer__inner">
            {/* ── Logo ── */}
            <img src={logo} alt="Messina Logo" className="footer__logo" />
            ...
            <div className="footer__bottom">
                <p className="footer__copyright">
                    © {new Date().getFullYear()} Messina Herramientas. Todos los derechos reservados.
                </p>
